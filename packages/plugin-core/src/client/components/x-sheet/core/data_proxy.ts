...
function canPaste(src: CellRange, dst: CellRange, error = (e) => {}) {
  const { merges } = this;
...
function setStyleBorder(ri, ci, bss: BorderStyles) {
