...
import PluginACLClient, { RolesManagerContext } from '@tachybase/plugin-acl/client';
...
const UserDepartmentsField = connect(() => {
  const { t: e } = useTranslation();
  return jsxs('div', {
    style: { color: '#ccc' },
...
const ne = {
  ...
  useComponentProps() {
    ...
    return {
      title: e('Enable link'),
      checked: ((i = r['x-component-props']) == null ? void 0 : i.enableLink) !== false,
      onChange(x) {
    ...
    this.app.pluginSettingsManager.add('users-permissions.departments', {
      ...
      Component: () => {
        ...
        return jsx(SchemaComponentContext.Provider, {
          ...
          children: jsx(ge, { children: jsx(mt, {}) }),
        });
      },
      sort: 2,
