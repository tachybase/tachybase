...
import { useTranslation, tval } from '../../locale';
...
var de = (w, s, n) => (s in w ? wt(w, s, { enumerable: true, configurable: true, writable: true, value: n }) : (w[s] = n)),
  y = (w, s) => {
...
const xe = () => {
    ...
    return jsxRuntime.jsx(SchemaComponent, {
      scope: { t: e },
      schema: {
        type: 'void',
        properties: {
        ...
        'x-decorator-props': {
          useValues(e) {
            const t = useActionContext(),
              o = useRecord();
            return useRequest(
              () => Promise.resolve({ data: { parent: y({}, o) } }),
              T(y({}, e), { refreshDeps: [t.visible] }),
            );
          },
        },
  ...
  K = React.createContext({ user: {}, department: {} }),
  ge = (e) => {
    ...
    const i = { resource: 'departments', action: 'list', params: { pagination: !1, filter: { parentId: null } } },
      x = useRequest(i);
    return jsxRuntime.jsx(K.Provider, {
      value: {
        user: t,
        setUser: o,
        department: a,
  ...
  Ce = (e) => {
    const { departmentsResource: t } = useContext(K),
      { service: o } = t || {};
    return jsxRuntime.jsx(ResourceActionContext.Provider, {
      value: y({}, o),
      children: jsxRuntime.jsx(CollectionProvider_deprecated, { collection: Q, children: e.children }),
    });
  },
  be = (e) => {
    ...
    return jsxRuntime.jsx(ResourceActionContext.Provider, {
      value: y({}, o),
      children: jsxRuntime.jsx(CollectionProvider_deprecated, { collection: ve, children: e.children }),
    });
  },
  X = () => {
    ...
    return (
      ...
      jsxRuntime.jsx('div', {
        ...
        children:
          c != null && c.length
            ? jsxRuntime.jsx(Tree.DirectoryTree, {
                loadData: x,
                treeData: c,
                loadedKeys: m,
                onSelect: h,
            ...
            : jsxRuntime.jsx(Empty, { image: Empty.PRESENTED_IMAGE_SIMPLE }),
      })
    );
  };
    ...
    children: [
      ...
      jsxRuntime.jsx(Dropdown, {
        ...
        children: jsxRuntime.jsx('div', {
          ...
          children: jsxRuntime.jsx(MoreOutlined, {}),
        }),
      }),
    ],
  });
...
const Ae = createStyles(({ css: e }) => ({
  ...
  Se = () => {
    const { t: e } = useTranslation(),
      ...
      f = useRequest(
            ...
            }),
        {
          ...
          onSuccess: (M, P) => {
            ...
            M &&
              ((!q || q === 'user') && M.users.length < l && h(!1),
              (!q || q === 'department') && M.departments.length < l && C(!1),
              g((se) => [...se, ...M.users]),
      ...
      $ = (M) => {
        M.target.value || (a(null), x(''), c(!1), f.mutate({}), g([]), A([]));
      },
      W = (M) => {
        const P = M.title,
          q = M.parent;
      ...
      H = (M) =>
        jsxRuntime.jsx(Button, {
          ...
          style: { padding: '0 8px' },
          onClick: (P) => {
            c(true), S({ values: y({ keyword: i, limit: l }, M) });
          },
        ...
        return !m.length && !d.length
          ...
          : (m.length &&
              (M.push({
                ...
                children: m.map((P) => ({
                  key: P.username,
                  label: jsxRuntime.jsxs('div', {
                    onClick: () => a(P),
                    children: [
                      jsxRuntime.jsx('div', { children: P.nickname || P.username }),
                      jsxRuntime.jsx('div', {
              ...
              b &&
                M.push({
                  type: 'group',
                  key: '0-loadMore',
                  label: jsxRuntime.jsx(H, { type: 'user', last: m[m.length - 1].id }),
                })),
            d.length &&
              (M.push({
                key: '1',
                ...
                children: d.map((P) => ({
                  key: P.id,
                  label: jsxRuntime.jsx('div', { onClick: () => o(P), children: W(P) }),
                })),
              }),
              F &&
                M.push({
                  type: 'group',
                  key: '1-loadMore',
                  label: jsxRuntime.jsx(H, { type: 'department', last: d[d.length - 1].id }),
                })),
            M);
      };
    return jsxRuntime.jsx(Dropdown, {
      ...
      open: r,
      onOpenChange: (M) => c(M),
      children: jsxRuntime.jsx(Input.Search, {
        allowClear: true,
        onClick: () => {
          i || c(!1);
        },
          ...
          l = (f) => {
            ...
            for (; S; ) {
              ...
              v[O]
                ...
                : (v[O] = T(y({}, S.parent || { id: O }), { childrenMap: { [S.id]: S } })),
                (S = S.parent);
            }
          },
          u = (f) => {
      ...
      A = useCallback((C) => {
        const v = (l) => {
          ...
          return !C[l] || C[l].isLeaf
            ? null
            : Object.values(((u = C[l]) == null ? void 0 : u.childrenMap) || {}).map((f) =>
                T(y({}, f), { title: t ? React.createElement(t, { node: f }) : f.title, children: v(f.id) }),
              );
        };
        return v('root');
      }, []),
...
function L(e, t) {
  return t.clone !== !1 && t.isMergeableObject(e) ? B(ke(e), e, t) : e;
}
function Ee(e, t, o) {
...
const ie = we(Ue),
  G = (e) => {
      ...
      A = (C) =>
        k(this, [C], function* ({ key: h, children: F }) {
          ...
          const { data: v } = yield c.list(
            ie(a, { pagination: !1, appends: ['parent(recursively=true)'], filter: { parentId: h } }),
          );
    ...
    return T(y({}, i), { loadData: A, getByKeyword: b });
  },
  Z = () => {
    var a, r;
  ...
  Be = () => {
    const [e, t] = useState(!1),
      ...
      m = () => {
        ...
        return {
          run() {
            const A = a.value || [];
            a.setValue([...A, ...i.current]), (i.current = []), d(!1);
          },
        };
      };
    useEffect(() => {
    ...
    const g = (d) => {
      var A;
      return jsxRuntime.jsx(ResourceActionProvider, {
        collection: 'users',
        request: {
    ...
    return jsxRuntime.jsxs(ActionContextProvider, {
      ...
      children: [
        ...
        jsxRuntime.jsx(SchemaComponent, {
          schema: fe,
  ...
  _e = () => {
    const { t: e } = useTranslation(),
      ...
      m = G({ label: ({ node: g }) => jsxRuntime.jsx(X.Item, { node: g, setVisible: o, setDrawer: r }) });
    return jsxRuntime.jsx(SchemaComponentOptions, {
      scope: { useCreateDepartment: $e, useUpdateDepartment: Le },
      children: jsxRuntime.jsxs(_.Provider, {
        value: m,
        children: [
          jsxRuntime.jsxs(Row, {
            children: [
              ...
              jsxRuntime.jsx(Button, {
                type: 'text',
                icon: jsxRuntime.jsx(UserOutlined, {}),
          ...
          jsxRuntime.jsx(Divider, { style: { margin: '12px 0' } }),
          jsxRuntime.jsx(X, {}),
          jsxRuntime.jsx(ActionContextProvider, {
            value: { visible: t, setVisible: o },
            children: jsxRuntime.jsx(RecordProvider, {
              record: a.node || {},
              children: jsxRuntime.jsx(SchemaComponent, {
                scope: { t: e },
  ...
  Ye = () => {
        ...
        jsxRuntime.jsxs(
          'span',
          {
            children: [
              ...
              i !== o.length - 1
                ? jsxRuntime.jsx('span', { style: { marginRight: 4, color: '#aaa' }, children: ',' })
                : '',
            ],
          },
          i,
    ...
    return jsxRuntime.jsx(EllipsisWithTooltip, { ellipsis: true, children: r });
  },
  Qe = () => {
    const { department: e } = useContext(K),
      o = (useRecord().departments || []).find((a) => (a == null ? void 0 : a.id) === (e == null ? void 0 : e.id));
    return jsxRuntime.jsx(Checkbox.ReadPretty, { value: o == null ? void 0 : o.departmentsUsers.isOwner });
  },
  ...
  et = (e) => {
    ...
    return (
      ...
      jsxRuntime.jsx(ResourceActionContext.Provider, {
        value: y({}, i),
        children: jsxRuntime.jsx(CollectionProvider_deprecated, {
          collection: Q,
          children: jsxRuntime.jsx(R.Provider, {
  ...
  pe = ({ useDataSource: e, useDisabled: t }) =>
    jsxRuntime.jsx(SchemaComponent, {
    ...
    useRequest(
      () =>
        g
          ...
          .list({ appends: ['parent(recursively=true)'], pagination: !1 })
          .then((l) => {
            var f;
      ...
      F = (l) =>
        k(this, null, function* () {
          yield g.resource('departments').removeOwner({ values: { userId: c.id, departmentId: l.id } }),
            t.success(o('Set successfully')),
            i.setValue(i.value.map((u) => T(y({}, u), { isOwner: u.id === l.id ? !1 : u.isOwner }))),
            x();
        }),
      C = (l, u) => {
        switch (l) {
      ...
      children: [
        jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [
            ((i == null ? void 0 : i.value) || []).map((l) =>
              jsxRuntime.jsxs(
                Tag,
                {
                  ...
                  children: [
                    jsxRuntime.jsx('span', { style: { marginRight: '5px' }, children: l.title }),
                    l.isMain ? jsxRuntime.jsx(Tag, { color: 'processing', bordered: !1, children: o('Main') }) : '',
                    jsxRuntime.jsx(Dropdown, {
                      menu: {
                        items: [
            ...
            jsxRuntime.jsx(Button, { icon: jsxRuntime.jsx(PlusOutlined, {}), onClick: () => r(true) }),
          ],
        }),
        jsxRuntime.jsx(SchemaComponent, {
          schema: Je,
  ...
  it = () => {
    ...
    const c = () => (t ? jsxRuntime.jsx(SchemaComponent, { schema: ze }) : null),
      i = () => (t ? jsxRuntime.jsx(SchemaComponent, { scope: { useRemoveMemberAction: st }, schema: We }) : null),
      x = useMemo(() => He(t, o), [t, o]);
    return jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [
        o
          ? jsxRuntime.jsx('h2', { children: e('Search results') })
          : jsxRuntime.jsx('h2', { children: e((t == null ? void 0 : t.title) || 'All users') }),
        jsxRuntime.jsx(SchemaComponent, {
          scope: {
  ...
  pt = () => {
    ...
    return jsxRuntime.jsx(le, T(y({}, e), { originData: o == null ? void 0 : o.data }));
  },
  lt = () => {
    const e = G(),
    ...
    return (
      ...
      jsxRuntime.jsx(le, T(y({}, e), { originData: c == null ? void 0 : c.data }))
    );
  },
  ut = () =>
    jsxRuntime.jsx(SchemaComponentOptions, {
      ...
      children: jsxRuntime.jsxs(Row, {
        ...
        children: [
          jsxRuntime.jsx(Col, {
            ...
            children: jsxRuntime.jsx(Ce, { children: jsxRuntime.jsx(_e, {}) }),
          }),
          jsxRuntime.jsx(Col, {
            flex: 'auto',
            style: { overflow: 'hidden' },
            children: jsxRuntime.jsx(be, { children: jsxRuntime.jsx(it, {}) }),
          }),
        ],
      }),
    }),
  ...
  gt = () => {
    ...
    return {
      run() {
        return k(this, null, function* () {
          yield t.resource('roles.departments', e.name).add({ values: c.map((x) => x.id) }), o.reset(), a(!1), r();
        });
      },
    };
  },
  ...
  UserDepartmentsField = connect(() => {
    const { t: e } = useTranslation();
    return jsxRuntime.jsxs('div', {
      style: { color: '#ccc' },
      children: [e('This field is currently not supported for use in form blocks.'), ' '],
    });
  ...
  te = {
    ...
    useComponentProps() {
      ...
      const { t: e } = useTranslation(),
        ...
        { uiSchema: r, fieldSchema: c, collectionField: i } = oe(),
        x = useFieldSchema(),
        m = c || x,
  ...
  bt = (e) => e['x-component'] === 'CollectionField',
  oe = () => {
  ...
  ne = {
    ...
    useComponentProps() {
      ...
      return {
        title: e('Enable link'),
        checked: ((i = r['x-component-props']) == null ? void 0 : i.enableLink) !== !1,
        onChange(x) {
          (r['x-component-props'] = T(y({}, r == null ? void 0 : r['x-component-props']), { enableLink: x })),
            (t.componentProps.enableLink = x),
            c.emit('patch', {
              schema: {
                'x-uid': r['x-uid'],
                'x-component-props': y({}, r == null ? void 0 : r['x-component-props']),
              },
            }),
            c.refresh();
        },
  ...
  re = {
    ...
    useComponentProps() {
      const { t: e } = useTranslation(),
        t = useField(),
        { fieldSchema: o, collectionField: a } = oe(),
        r = useFieldSchema(),
        c = o || r,
...
export class DepartmentsPlugin extends Plugin {
  async load() {
    ...
    this.app.schemaSettingsManager.add(At);
    this.app.schemaSettingsManager.add(St);
    this.app.schemaSettingsManager.add(Dt);
    this.app.pluginSettingsManager.add('users-permissions.departments', {
      icon: 'ApartmentOutlined',
      title: tval('Departments'),
      Component: () => {
        const o = useSchemaComponentContext();
        return jsxRuntime.jsx(SchemaComponentContext.Provider, {
          value: T(y({}, o), { designable: !1 }),
          children: jsxRuntime.jsx(ge, { children: jsxRuntime.jsx(mt, {}) }),
        });
      },
      sort: 2,
