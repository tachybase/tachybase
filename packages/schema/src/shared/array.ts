...
export function every<T extends {}>(val: T, iterator: EachObjectIterator, revert?: boolean): boolean;
...
export function some<T extends {}>(val: T, iterator: EachObjectIterator, revert?: boolean): boolean;
...
export function findIndex<T extends {}>(val: T, iterator: EachObjectIterator, revert?: boolean): keyof T;
...
export function find<T extends {}>(val: T, iterator: EachObjectIterator, revert?: boolean): T[keyof T];
...
export function move<T extends any>(array: T[], fromIndex: number, toIndex: number) {
