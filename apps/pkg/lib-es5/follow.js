  ...
  return new Promise((resolve) => {
    resolve(
      (0, resolve_1.sync)(x, {
        ...
        isFile: (file) => {
          if (opts.ignoreFile && path_1.default.join(path_1.default.dirname(opts.ignoreFile), PROOF) === file) {
            return true;
          }
          let stat;
          try {
        ...
        isDirectory: (directory) => {
          if (opts.ignoreFile && parentDirectoriesContain(opts.ignoreFile, directory)) {
            return false;
          }
          let stat;
          try {
