...
const nodeModulePath = path.join(process.env.NODE_MODULES_PATH, '@tachybase/app-web/dist/index.html');
...
if (fs.existsSync(distPath)) {
  ...
  servePath = path.join(process.env.NODE_MODULES_PATH, '@tachybase/app-web/dist');
} else {
